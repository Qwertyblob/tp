...
* You can remove all the class’s tags by typing `t/` without
  specifying any tags after it.

Examples:
*  `editc 1 c/M2a tt/T0000067` Edits the class name and tutor of the 1st class to be `M2a` and `T0000067` respectively.
*  `editc 2 tm/1200 t/` Edits the time of the 2nd class to be `1200` and clears all existing tags.

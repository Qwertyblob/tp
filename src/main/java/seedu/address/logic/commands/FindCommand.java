...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all contacts matching the given criteria. " +
    ...
    public FindCommand(ContactMatchesPredicate predicate) {
